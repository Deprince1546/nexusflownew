...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NexusFlow" },
      { name: "description", content: "Your digital work, connected by one intelligent AI agent." },
      { name: "author", content: "NexusFlow" },
      { property: "og:title", content: "NexusFlow" },
      { property: "og:description", content: "Your digital work, connected by one intelligent AI agent." },
